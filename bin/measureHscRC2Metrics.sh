...
${FARO_DIR}/make_job_document.py ${RC2_SUBSET_DIR}/SMALL_HSC jenkins/faro_singleFrame
${FARO_DIR}/make_job_document.py ${RC2_SUBSET_DIR}/SMALL_HSC jenkins/faro_coadd
